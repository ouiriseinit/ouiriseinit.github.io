...
description: Visualize and apply a file-extension-based complexity scale across project tiers. Use when the user asks about complexity levels, file organization, project structure, or when they mention the complexity scale sketch. Helps estimate effort, decide where to prototype, and refactor code across Test Drive, Utility Layer, and Component Layer tiers.
Complexity Scale
